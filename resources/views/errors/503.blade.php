...
<body>
    ...
    <button class="theme-btn" id="themeBtn" title="Toggle tema" aria-label="Toggle dark/light mode">
        <svg id="iconSun" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
        ...
        <svg id="iconMoon" xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor"
            viewBox="0 0 24 24">
    ...
    <div class="card" role="main">
        ...
        <div class="logo-container" style="text-align: center;">
            <img class="logo" src="/app_logo.png" alt="logo" style="width: 100px;">
            <div style="margin-bottom: 24px; font-weight: bold;">
                E-PASTE
            </div>
        </div>
        <!-- gears -->
        <div class="gear-wrap" aria-hidden="true">
            <svg class="gear" xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor"
                viewBox="0 0 24 24">
                <path
                    d="M12 15a3 3 0 100-6 3 3 0 000 6zm8.94-3a8.001 8.001 0 00-.16-1.57l1.8-1.24a.5.5 0 00.14-.64l-1.9-3.3a.5.5 0 00-.61-.22l-2.12.85a7.94 7.94 0 00-1.36-.78l-.32-2.25A.5.5 0 0015.9 3h-3.8a.5.5 0 00-.5.43l-.32 2.25a7.94 7.94 0 00-1.36.78L7.8 5.61a.5.5 0 00-.61.22l-1.9 3.3a.5.5 0 00.14.64l1.8 1.24A8.16 8.16 0 007.06 12a8.16 8.16 0 00.17 1.57l-1.8 1.24a.5.5 0 00-.14.64l1.9 3.3a.5.5 0 00.61.22l2.12-.85c.43.29.89.54 1.36.78l.32 2.25c.06.25.28.43.5.43h3.8c.22 0 .44-.18.5-.43l.32-2.25a7.94 7.94 0 001.36-.78l2.12.85c.23.09.49 0 .61-.22l1.9-3.3a.5.5 0 00-.14-.64l-1.8-1.24c.09-.51.14-1.04.14-1.57z" />
            </svg>
        ...
        <div class="chips">
            ...
            <div class="chip">
                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor"
                    viewBox="0 0 24 24">
                    <path
                        d="M12 1a11 11 0 100 22A11 11 0 0012 1zm0 2a9 9 0 110 18A9 9 0 0112 3zm-.5 4v5.5l4.3 2.5-.8 1.3-4.8-2.8V7h1.3z"
                        style="display:none" />
        ...
        @if ($exception->getMessage())
            <div
                style="background:rgba(239,68,68,.08);border:1px solid rgba(239,68,68,.2);border-radius:.75rem;padding:.75rem 1rem;font-size:.8rem;color:#b91c1c;margin-bottom:1.5rem;text-align:left;">
